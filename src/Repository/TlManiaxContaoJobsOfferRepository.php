...
class TlManiaxContaoJobsOfferRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, TlManiaxContaoJobsOffer::class);
    }
     ...
     */
    public function findPublishedByIdOrAlias(string $alias): ?TlManiaxContaoJobsOffer
    {
        $qb = $this->createQueryBuilder('a');
