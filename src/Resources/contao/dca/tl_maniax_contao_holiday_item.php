            ...
            'eval' => [
                'columnFields' => [
                    'doc' => [
                        ...
                        'eval' => ['style'=> 'width:50%', 'includeBlankOption' => true, 'tl_class' => 'w50', 'mandatory' => true, 'chosen' => true,],
                    ],
                    'vertretungStart' => [
                        'exclude' => true,
                        'inputType' => 'text',
                        'eval' => ['style'=> 'width:20%', 'rgxp' => 'date', 'datepicker' => true, 'tl_class' => 'clr w50 wizard','mandatory' => true,],
                    ],
                    'vertretungStop' => [
                        'exclude' => true,
                        'inputType' => 'text',
