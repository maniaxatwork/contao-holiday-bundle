...
class DefaultTwoFactorFormRenderer_892ae3f extends \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\DefaultTwoFactorFormRenderer implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer3a454 && ($this->initializer3a454->__invoke($valueHolderdbe75, $this, 'renderForm', array('request' => $request, 'templateVars' => $templateVars), $this->initializer3a454) || 1) && $this->valueHolderdbe75 = $valueHolderdbe75;
        return $this->valueHolderdbe75->renderForm($request, $templateVars);
    }
    ...
    public function __construct(\Twig\Environment $twigRenderer, string $template, array $templateVars = [])
    {
        ...
        $this->valueHolderdbe75->__construct($twigRenderer, $template, $templateVars);
    }
