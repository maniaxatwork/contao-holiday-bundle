...
// Returns the private 'mailer.transport_factory.native' shared service.
...
return new \Symfony\Component\Mailer\Transport\NativeTransportFactory(($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()), ($this->privates['http_client'] ?? $this->load('getHttpClientService.php')), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()));
